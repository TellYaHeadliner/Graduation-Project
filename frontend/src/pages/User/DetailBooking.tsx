                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border p-4 rounded-md">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm border p-4 rounded-md">
                            ...
                            <p>
                                <span className="font-semibold">Email: </span> {getDetailBooking.data?.data.customer.email}</p>
                    ...
                    <div>
                        ...
                        </h2>
                        {
                            getDetailBooking.data?.data.booking_details.map((room) => (
                                <div key={room.room_code} className="border p-4 rounded-md bg-gray-50 mb-4">
                        ...
                        </h2>
                        {
                            getDetailBooking.data?.data.booking_services.length === 0 ? (
                                ...
                                getDetailBooking.data?.data.booking_services.map((service) => (
                                    <div key={service.name} className="border p-4 rounded-md bg-gray-50 bg-4">
                        ...
                        </h2>
                        {
                            getDetailBooking.data?.data.booking_combos?.length === 0 ? (
                                ...
                                getDetailBooking.data?.data.booking_combos?.map((combo) => (
                                    <div key={combo.combo_name} className="border p-4 rounded-md bg-gray-50 bg-4">
