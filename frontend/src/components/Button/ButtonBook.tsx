export default function ButtonBook(){
    return (
        <div className="hidden md:flex 2xl:flex flex-row items-center gap-1 text-white rounded-sm mr-2 border border-white">
            <span className="bg-third text-white px-2 rounded-md flex items-center justify-center w-[30px] h-[30px] gap-2 sm:w-auto sm:px-3 sm:flex sm:flex-row border-secondary hover:bg-accent">
