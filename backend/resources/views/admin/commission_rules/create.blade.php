...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            <x-form :action="route('admin.commission_rule.store')" type="post" :validate="true">
                <div class="row justify-content-center">
                    @include('admin.commission_rules.forms.create-left')
                    @include('admin.commission_rules.forms.create-right')
                </div>
            </x-form>
        </div>
    </div>
