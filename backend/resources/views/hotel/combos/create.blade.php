...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            <x-form :action="route('hotel.hotel_service.store',Auth()->user()->id)" type="post" :validate="true">
                <div class="row justify-content-center">
                    @include('hotel.hotel_services.forms.create-left')
                    @include('hotel.hotel_services.forms.create-right')
                </div>
            </x-form>
        </div>
    </div>
