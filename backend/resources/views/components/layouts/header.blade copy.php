            ...
            <div class="col-3 d-flex justify-content-center align-items-center">
                ...
                <div class="position-relative me-5">
                    ...
                    <div class="dropdown-menu" id="userDropdown">
                        ...
                        <a id="showModal" href="{{ route('user.logout') }}" class="dropdown-item"
    ...
    <div class="d-flex align-items-center justify-content-center wrap-nav bg-nav-responsive">
        <div class="row p-m-0 container">
            ...
            <div style="height: 45px"
                class="col-12 align-items-center justify-content-center d-none d-xl-flex bold-text">
                <ul class="nav">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Lấy chiều cao của thanh nav và thiết lập biến CSS
        const navHeight = document.querySelector('.nav').offsetHeight;
        document.documentElement.style.setProperty('--nav-height', `${navHeight}px`);

        // Xử lý sự kiện cho thiết bị cảm ứng
        ...
        function closeAllSubmenus() {
            const activeMenus = document.querySelectorAll('.subcategory-menu.active');
        ...
        document.addEventListener('click', function(e) {
            if (!e.target.closest('.category-dropdown') && !e.target.closest('.category-menu-wrapper')) {
                closeAllSubmenus();
            }
        });
        ...
        if (categoryDropdown) {
            const categoryLink = categoryDropdown.querySelector('.category-link');
