...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            <x-form :action="route('hotel.room_type.store',Auth()->user()->id)" type="post" :validate="true">
                <div class="row justify-content-center">
                    @include('hotel.room_types.forms.create-left')
                    @include('hotel.room_types.forms.create-right')
                </div>
            </x-form>
        </div>
    </div>
